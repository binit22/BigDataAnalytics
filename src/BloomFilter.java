...
public class BloomFilter {
    ...
    public static final long bits = 4194304*32;
    public static int bitVectorSize = (int)bits/64;
    public static long[] vector = new long[bitVectorSize];
    public static long[] vector2 = new long[bitVectorSize];
    public int unique = 0;
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            while((URL = br.readLine()) != null){
                ...
                URL = URL.split("\\s+")[6];
                count++;
                filter.add(filter.hash8(URL));
//                filter.add(filter.hash4(URL));
                filter.add(filter.hash9(URL));
                filter.add(filter.hash4(URL));
            }
            ...
            while((URL = br.readLine()) != null){
                ...
                URL = URL.split("\\s+")[6];
                count++;
                if(filter.search(filter.hash8(URL),URL))
                    continue;
//                if(filter.search(filter.hash4(URL),URL))
//                    continue;
                if (filter.search(filter.hash9(URL),URL))
                    continue;
                if (filter.search(filter.hash4(URL),URL))
                    continue;
            }
...
//            System.out.println(URL);
            if(searchUnique(hash8(URL)) || searchUnique(hash4(URL)) || searchUnique(hash9(URL)) ){
                addUnique(hash4(URL));
                addUnique(hash8(URL));
                addUnique(hash9(URL));
                this.unique++;
